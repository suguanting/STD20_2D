    ...
    !------计算域尺度量------!
    LEFT=-10.0D0!-15.0D0!-10.0D0!-7.5D0!-20.0D0!
    RIGH= 10.0D0! 15.0D0! 10.0D0!15.0D0! 20.0D0!
    BOTT=-10.0D0!-15.0D0!-10.0D0!-7.5D0!-20.0D0!
    TOPP= 10.0D0! 15.0D0! 10.0D0! 7.5D0! 20.0D0!
    ...
    LEIN=-2.0D0!-1.2D0!-0.7D0!-1.2D0
    RIIN= 2.0D0! 0.0D0! 0.7D0! 1.2D0
    BOIN=-0.8D0!-0.7D0!-1.0D0!-2.5D0
    TOIN= 0.8D0! 0.7D0! 1.0D0! 2.5D0
    ...
    IB_SHAPE=2
    !------各种无量纲参数和准则数------!
    Re=2606.155815D0!1954.616861D0!模拟1请确认符合模拟目标
    ...
    RIIN= 3.0D0! 0.7D0! 1.2D0
    BOIN=-3.5D0!-1.0D0!-2.5D0
    ...
    !------确定时间步------!
    DT=10.30007311D0/DBLE(NCYCLE)!7.725054831D0/DBLE(NCYCLE)!模拟1请确认符合模拟目标
