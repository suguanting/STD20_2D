    ...
    ALLOCATE( IB_ITSCT_UXM1(IM,0:JM),IB_ITSCT_VXM1(0:IM,JM) )
    ALLOCATE( IB_IPSVL_UXM1(IM,0:JM),IB_IPSVL_VXM1(0:IM,JM) )
    ALLOCATE( IB_ITSCT_UYM1(IM,0:JM),IB_ITSCT_VYM1(0:IM,JM) )
    ALLOCATE( IB_IPSVL_UYM1(IM,0:JM),IB_IPSVL_VYM1(0:IM,JM) )
    ...
    !    OPEN(UNIT=310,FILE='CXC_CYC_CXT_CYT_CXF_CYF_2.DAT')
    !    OPEN(UNIT=311,FILE='CU_CP_CUX_CUY_CPX_CPY_2.DAT')
    !    OPEN(UNIT=312,FILE='CP_PROP_ELEV_EFFE_AERO_2.DAT')
    !    OPEN(UNIT=313,FILE='E_PROP_ELEV_TOTAL_2.DAT')
    !END IF
    OPEN(UNIT=320,FILE='CXC_CYC_CTRL_VLM_SP.DAT')
    OPEN(UNIT=321,FILE='CXC_CYC_CTRL_VLM_DP.DAT')
    IF(BOUNDARY_EXISTENCE_1==1)THEN
        OPEN(UNIT=330,FILE='CXC_CYC_SRFC_INTGRTN_EXACT_SP_1.DAT')
        OPEN(UNIT=331,FILE='CXC_CYC_SRFC_INTGRTN_EXACT_DP_1.DAT')
    END IF
    IF(BOUNDARY_EXISTENCE_2==1)THEN
        OPEN(UNIT=340,FILE='CXC_CYC_SRFC_INTGRTN_EXACT_SP_2.DAT')
        OPEN(UNIT=341,FILE='CXC_CYC_SRFC_INTGRTN_EXACT_DP_2.DAT')
    END IF
    IF(BOUNDARY_EXISTENCE_1==1)THEN
        OPEN(UNIT=350,FILE='CXC_CYC_SRFC_INTGRTN_ALL_SP_1.DAT')
        OPEN(UNIT=351,FILE='CXC_CYC_SRFC_INTGRTN_ALL_DP_1.DAT')
    END IF
    IF(BOUNDARY_EXISTENCE_2==1)THEN
        OPEN(UNIT=360,FILE='CXC_CYC_SRFC_INTGRTN_ALL_SP_2.DAT')
        OPEN(UNIT=361,FILE='CXC_CYC_SRFC_INTGRTN_ALL_DP_2.DAT')
    END IF
    IF(BOUNDARY_EXISTENCE_1==1)THEN
        OPEN(UNIT=370,FILE='CXC_CYC_SRFC_INTGRTN_SOME_SP_1.DAT')
        OPEN(UNIT=371,FILE='CXC_CYC_SRFC_INTGRTN_SOME_DP_1.DAT')
    END IF
    IF(BOUNDARY_EXISTENCE_2==1)THEN
        OPEN(UNIT=380,FILE='CXC_CYC_SRFC_INTGRTN_SOME_SP_2.DAT')
        OPEN(UNIT=381,FILE='CXC_CYC_SRFC_INTGRTN_SOME_DP_2.DAT')
    END IF
