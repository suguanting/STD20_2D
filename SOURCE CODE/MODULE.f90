    ...
    REAL(KIND=8),ALLOCATABLE::UM(:,:),VM(:,:)
    REAL(KIND=8),ALLOCATABLE::UM1(:,:),VM1(:,:)
    REAL(KIND=8),ALLOCATABLE::UM2(:,:),VM2(:,:)
    !------临时计数器------!
    ...
    !------上一时间层------!
    REAL(KIND=8),ALLOCATABLE::LAPLACE_VXM1(:,:),LAPLACE_VYM1(:,:)!
    REAL(KIND=8),ALLOCATABLE::LAPLACE_UXM1(:,:),LAPLACE_UYM1(:,:)!
    REAL(KIND=8),ALLOCATABLE::CONVECT_VXM1(:,:),CONVECT_VYM1(:,:)!
    REAL(KIND=8),ALLOCATABLE::CONVECT_UXM1(:,:),CONVECT_UYM1(:,:)!
    REAL(KIND=8),ALLOCATABLE::CONVECT_VXM2(:,:),CONVECT_VYM2(:,:)!
    REAL(KIND=8),ALLOCATABLE::CONVECT_UXM2(:,:),CONVECT_UYM2(:,:)!

    INTEGER     ,ALLOCATABLE::TYPEUXM1(:,:),TYPEVXM1(:,:)!10:FLOW,-10:SOLID
    INTEGER     ,ALLOCATABLE::TYPEUYM1(:,:),TYPEVYM1(:,:)!10:FLOW,-10:SOLID
    REAL(KIND=8),ALLOCATABLE::IB_ITSCT_UXM1(:,:),IB_ITSCT_VXM1(:,:)!INTERSECTION LOCATION
    REAL(KIND=8),ALLOCATABLE::IB_IPSVL_UXM1(:,:),IB_IPSVL_VXM1(:,:)!IMPOSED VELOCITY
    REAL(KIND=8),ALLOCATABLE::IB_ITSCT_UYM1(:,:),IB_ITSCT_VYM1(:,:)!INTERSECTION LOCATION
    REAL(KIND=8),ALLOCATABLE::IB_IPSVL_UYM1(:,:),IB_IPSVL_VYM1(:,:)!IMPOSED VELOCITY
